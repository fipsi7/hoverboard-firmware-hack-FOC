...
// *******************************************************************
// INFO:
// • This sketch uses the the Serial Software interface to communicate and send
// commands to the hoverboard • The built-in (HW) Serial interface is used for
// debugging and visualization. In case the debugging is not needed,
//   it is recommended to use the built-in Serial interface for full speed
//   perfomace.
// • The data packaging includes a Start Frame, checksum, and re-syncronization
// capability for reliable communication
//
...
// • Option 2: Serial on Left Sensor cable (long wired cable) - use only
// with 3.3V devices! The USART2 pins are not 5V tolerant!
...
void Receive() {
  ...
  if (HoverSerial.available()) {
    ...
    bufStartFrame = ((uint16_t)(incomingByte) << 8) |
