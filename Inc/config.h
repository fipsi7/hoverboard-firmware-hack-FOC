...
#define BAT_CALIB_REAL_VOLTAGE  4967      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define BAT_CALIB_ADC           1999      // adc-value measured by mainboard (value nr 5 on UART debug output) SCHWARZ = 1999
//#define BAT_CALIB_ADC           1912      // adc-value measured by mainboard (value nr 5 on UART debug output) BLAU = 1912
